  ...
  ready(async()=>{
    ...
    if(seasons.length){
      ...
      if(recentTitle&&!document.getElementById('seasonCompare')){
        ...
        if(seasons.length<2){
          section.innerHTML='<h2 class="title">📊 SEASON COMPARE</h2><p class="subline">Compare Madden campaigns side by side once a second season is available.</p><article class="season-compare-panel"><div class="kicker">COMPARE MODE</div><div class="season-compare-empty"><strong>SEASON 2 REQUIRED</strong><p>Your current campaign is the only tracked Madden season. Compare Mode will activate automatically after you start and log a second season.</p></div></article>';
